...
#plots----------------------------------------------
    ...
    # x axis
    array1 = np.arange(0.0, 12.1, 2.0)
    strlabs = ["%.1f" % x for x in array1]  # strings serve as labels of xticks
    plt.xticks(array1,strlabs)
    # y axis
    array1 = np.arange(-0.05, 0.29, 0.05)
    array2 = 100.0*array1  # unit convertion, m to cm
    strlabs = ["%.1f" % x for x in array2]  # strings serve as labels of yticks
    plt.yticks(array1,strlabs)
    ...
    # x axis
    array1 = np.arange(0.0, 12.1, 2.0)
    strlabs = ["%.1f" % x for x in array1]   
    plt.xticks(array1,strlabs)
    # y axis
    array1 = np.arange(-1.21, 4.21, 0.5) 
    strlabs = ["%.1f" % x for x in array1]  
    plt.yticks(array1,strlabs)
    minorLocator = AutoMinorLocator()
    ...
    plt.grid(True)
    pylab.title('Fluid pressure head at 32 m')
    ...
    # x axis
    array1 = np.arange(0.0, 20.1, 2.0)
    strlabs = ["%.1f" % x for x in array1]   
    plt.xticks(array1,strlabs)
    # y axis
    array1 = np.arange(-0.05, 0.29, 0.05)
    array2 = 100.0*array1   
    strlabs = ["%.1f" % x for x in array2]   
    plt.yticks(array1,strlabs)
    minorLocator = AutoMinorLocator()
    ...
    plt.ylabel('Pressure (kPa)')
    plt.grid(True)
    pylab.title('Fluid pressure head at 66 m')
    ...
    l_exp = plotcomparison(5,t02,h02_low,h02_high,[],[])
    ...
    plt.xticks(array1,strlabs)
    # y axis
    array1 = np.arange(-0.09, 0.81, 0.1)
    array2 = 100.0*array1   
    strlabs = ["%.1f" % x for x in array2]  
    plt.yticks(array1,strlabs)
    minorLocator = AutoMinorLocator()
